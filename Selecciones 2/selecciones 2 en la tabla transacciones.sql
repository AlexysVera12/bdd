...
--values(23210, '32015', 400, 'C', FALTA FECHA, '13:55');
...
select * from transacciones where tipo = 'C' and numero_cuenta between '22007' and '22010';
select * from transacciones where tipo = 'D' and fecha = '25/05/2025' and numero_cuenta between '22007' and '22010';
select * from transacciones where codigo between 1 and 5 and numero_cuenta = '22002' or numero_cuenta = '22004' and fecha between '26/05/2025' and '29/05/2025'